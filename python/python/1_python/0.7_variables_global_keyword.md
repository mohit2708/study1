...
* SIn Python, single quotes (' ') and double quotes (" ") are functionally the same and both are used to create strings. The choice mainly depends on readability and avoiding unnecessary escaping when the string contains quotes.
