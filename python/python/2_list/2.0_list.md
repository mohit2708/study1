...
|       | [How to Check if Item Exists?](#how-to-check-if-item-exists)                                                    |
...
#### map()
* map() का use हर element पर कोई function apply करने के लिए होता है।
```python
numbers = [1, 2, 3, 4]
...
#### filter()
* filter() का use condition के आधार पर elements को select करने के लिए होता है।
* Simple meaning: सिर्फ वे elements रखना जो condition satisfy करें।
```python
numbers = [1, 2, 3, 4, 5, 6]
...
#### reduce()
* reduce() का use multiple elements को combine करके एक single result बनाने के लिए होता है।
* reduce() को functools से import करना पड़ता है।
```python
