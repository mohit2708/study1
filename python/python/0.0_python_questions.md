...
| No.📜  | [Python Basic Interview Questions]()                                          |
| :---: | ----------------------------------------------------------------------------- |
...
|       | [What is PEP 8?](./1_python/0.1_python_basic.md#ques-what-is-pep-8)                                                                   |
...
|       | [Is indentation required in python?](./1_python/0.1_python_basic.md#ques-is-indentation-required-in-python)                           |
|       | [File Extensions in Python?](./1_python/0.1_python_basic.md#ques-file-extensions-in-python)                                           |
...
|       | [What is If Else?](./1_python/0.5_if_else.md#ques-what-is-if-else)                                                                    |
|       | [Python While Loops](./1_python/0.6_while_loop.md#ques-python-while-loops)                                                            |
...
|   ✏️   | [Difference between **List** and **Tuples** in Python?](./2_list/2.0_list.md#ques-difference-between-list-and-tuples-in-python) |
<div style="page-break-before: always;"></div>
