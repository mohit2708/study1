...
2. [Django install karo](/python/django/interview_questions/django_project_setup.md#2-django-install-karo)
3. [Django project create karo](/python/django/interview_questions/django_project_setup.md#django-project-create-karo)
4. [Server run karo](/python/django/interview_questions/django_project_setup.md#4-server-run-karo)
5. [App create karo](/python/django/interview_questions/django_project_setup.md#5-app-create-karo)
6. App ko settings.py mein add karo
7. First View banao
8. URL seeting
9. Database migrations
10. [Admin user banao](/python/django/interview_questions/superuser.md#how-to-create-superuser)
...
11. [What is Django Apps?](/python/django/interview_questions/3_django.md#django-apps)
    1.  ⭐ [How to Create app?](/python/django/interview_questions/3_django.md#creating-an-app)
12. ⭐ [Project vs App](/python/django/interview_questions/3_django.md#project-vs-app)
13. ⭐ [How to run server?](/python/django/interview_questions/3_django.md#how-to-run-server)
14. [Why is Django called a "loosely coupled" framework?](/python/django/interview_questions/3_django.md#why-is-django-called-a-loosely-coupled-framework)
15. [What are the advantages of Django?](/python/django/interview_questions/3_django.md#what-are-the-advantages-of-django)
16. Difference between MVT and MVC? - no
17. Why is Django called a "batteries-included" framework? - no

### 🧠 [**Django SuperUser Questions**](/python/django/interview_questions/superuser.md)
...
6. [See the specific App command?](/python/django/interview_questions/models_migration.md#see-the-specific-app-command)
7. [To see the raw SQL Query](/python/django/interview_questions/models_migration.md#to-see-the-raw-sql-query)
8. [What is the Meta Class?](/python/django/interview_questions/models_migration.md#what-is-the-meta-class)
...
12. [What is indexes in Django?](/python/django/interview_questions/models_migration.md#what-is-indexes-in-django)
13. ⭐ [What is inspectdb in Django?](/python/django/interview_questions/models_migration.md#what-is-inspectdb-in-django)
...
19. [What is select_related()?](/python/django/interview_questions/view.md#what-is-select_related)
20. [What is prefetch_related()?](/python/django/interview_questions/view.md#what-is-prefetch_related)
21. [Diff between select_related and prefetch_related?](/python/django/interview_questions/view.md#select_related-vs-prefetch_related)
22. [What is Q Object?](/python/django/interview_questions/view.md#what-is-q-object)
23. 
...
1. [What is URL Routing in Django?](/python/django/interview_questions/URLs_Routing.md#what-is-url-routing-in-django)
2. [Difference between path() and re_path()?](/python/django/interview_questions/URLs_Routing.md#what-is-path-and-re_path)
3. [How do you pass parameters in URLs?](/python/django/interview_questions/URLs_Routing.md#how-do-you-pass-parameters-in-urls)
4. [What is URL namespace?](/python/django/interview_questions/URLs_Routing.md#what-is-url-namespace)
5. [What is include()?](/python/django/interview_questions/URLs_Routing.md#why-use-include)
6. [What is URL reversing?](/python/django/interview_questions/URLs_Routing.md#what-is-url-reversing)
7. [What is reverse()?](/python/django/interview_questions/URLs_Routing.md#what-is-reverse-in-django)
8. [reverse() vs url?](/python/django/interview_questions/URLs_Routing.md#reverse-vs-url)
...
2. [Difference between {{ }} and {% %}?](/python/django/interview_questions/Templates.md#-difference-between---and--)
3. [What are template tags?](/python/django/interview_questions/Templates.md#-what-are-template-tags)
4. [What are filters?](/python/django/interview_questions/Templates.md#what-are-filters)
5. How do you extend templates?
6. What is template inheritance?
7. [What is base.html?](/python/django/interview_questions/Templates.md#what-is-basehtml)
8. [How do you load static files in templates?](/python/django/interview_questions/Templates.md#how-do-you-load-static-files-in-templates)
9. [Difference between static files and media files?](/python/django/interview_questions/Templates.md#difference-between-static-files-and-media-files)
10. 
11. no
12. What is context in Django templates?
13. How do you pass data from a view to a template?
14. What is the difference between Template Tags and Template Filters?
15. What is {% include %} in Django?
16. What is {% block %} in Django templates?
17. What is {% extends %} vs {% include %}?
18. What is {% csrf_token %} and why is it used?
...
5.  What is {% with %} tag?
6.  What is {% comment %} tag?
7.  How do you write comments in Django templates?
8.  What are built-in template filters in Django?
9.  Can we create custom template filters? How?
10. Can we create custom template tags? How?
11. What is safe filter?
12. What is default filter?
13. What is truncatechars filter?
14. What is date filter?
16. How do you display model data in a template?
17. How do you access related model objects in a template?
18. How do you display images uploaded by users?
19. What happens if a template variable does not exist?
20. How do you configure the Django template directory?
21. What is TEMPLATES setting in settings.py?
22. What is DIRS in the TEMPLATES configuration?
23. What is APP_DIRS?
24. What is the difference between Django Templates and Jinja2?
25. How does Django Template Engine prevent XSS attacks?
