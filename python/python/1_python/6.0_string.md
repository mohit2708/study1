...
### What is the difference between isalpha(), isdigit(), and isalnum()?
```python
"abc".isalpha()   # True
"123".isdigit()   # True
"abc123".isalnum() # True
...
```python
str = 'The first president of the organization..'
print(str.count('o'))   # Output:- 3
print('The first president of the organization..'.count('o')) # Output:- 3
```
